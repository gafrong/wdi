...
def same_n_line(a,b)
	puts ($subway_stops.values[0].index(b) - $subway_stops.values[0].index(a)).abs
end

def same_l_line(a,b)
	puts ($subway_stops.values[1].index(b) - $subway_stops.values[1].index(a)).abs
end

def same_6_line(a,b)
	puts ($subway_stops.values[2].index(b) - $subway_stops.values[2].index(a)).abs
end
...
def start_n_finish_l(a,b)
	puts (($subway_stops.values[0].index(a) - $subway_stops.values[0].index("Union_S")).abs) + (($subway_stops.values[1].index("Union_S")-($subway_stops.values[1].index(b))).abs)
end

def start_n_finish_6(a,b)
	puts (($subway_stops.values[0].index(a) - $subway_stops.values[0].index("Union_S")).abs) + (($subway_stops.values[2].index("Union_S")-($subway_stops.values[2].index(b))).abs)
end

def start_l_finish_n(a,b)
	puts (($subway_stops.values[1].index(a) - $subway_stops.values[1].index("Union_S")).abs) + (($subway_stops.values[0].index("Union_S")-($subway_stops.values[0].index(b))).abs)
end

def start_l_finish_6(a,b)
	puts (($subway_stops.values[1].index(a) - $subway_stops.values[1].index("Union_S")).abs) + (($subway_stops.values[2].index("Union_S")-($subway_stops.values[2].index(b))).abs)
end

def start_6_finish_n(a,b)
	puts (($subway_stops.values[2].index(a) - $subway_stops.values[2].index("Union_S")).abs) + (($subway_stops.values[0].index("Union_S")-($subway_stops.values[0].index(b))).abs)
end

def start_6_finish_l(a,b)
	puts (($subway_stops.values[2].index(a) - $subway_stops.values[2].index("Union_S")).abs) + (($subway_stops.values[1].index("Union_S")-($subway_stops.values[1].index(b))).abs)
end
